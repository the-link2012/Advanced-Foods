...
#Run loops
function af:loop/tick/base
function af:load/load_message

#looping
scoreboard objectives add afloop dummy
scoreboard players add 5hz afloop 0
scoreboard players add 10hz afloop 0
scoreboard players add 1hz afloop 0
